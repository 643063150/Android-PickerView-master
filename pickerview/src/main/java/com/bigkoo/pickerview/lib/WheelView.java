...
public class WheelView extends View {
    ...
    OnViewStopScrollListener onViewStopScrollListener;
    ...
    public void setOnWheelViewStopScrollListener(OnViewStopScrollListener onWheelViewStopScrollListener) {
        this.onViewStopScrollListener = onWheelViewStopScrollListener;
    }

    //滑动停止监听，你也可以直接把停止后的下标在监听里返回
    public void setOnstop() {
        if (onViewStopScrollListener != null) {
            onViewStopScrollListener.OnsopListener();
        }
    }
