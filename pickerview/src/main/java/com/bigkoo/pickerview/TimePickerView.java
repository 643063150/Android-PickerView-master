...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    private final boolean buttonVisables;
    ...
    public TimePickerView(Builder builder) {
        ...
        this.buttonVisables=builder.buttonVisables;
    ...
    public static class Builder {
        ...
        private boolean buttonVisables=true;
        ...
        public Builder setButtonVisables(boolean buttonVisables) {
            this.buttonVisables = buttonVisables;
            return this;
        }
        /**
         * 设置分割线之间的文字的颜色
...
//        setDialogOutSideCancelable(cancelable);
        ...
        if (customListener == null) {
            ...
            if (buttonVisables){
                rv_top_bar.setVisibility(View.VISIBLE);
            }else {
        ...
        wheelTime.setOnStopScrollListener(new WheelTime.OnScrollStopListener() {
            @Override
            public void WheelView(WheelView wheelView) {
                stop();
            }
        });
    }
