...
import com.bigkoo.pickerview.listener.OnViewStopScrollListener;
...
public class WheelTime {
     ...
     /*   wv_month.setLabel(context.getString(R.string.pickerview_month));*/
      ...
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
       ...
       /* wv_seconds.setLabel(context.getString(R.string.pickerview_seconds));// 添加文字*/
        ...
        setContentTextSize();
        setOnViewStopScrollListener(wv_year);
        setOnViewStopScrollListener(wv_month);
        setOnViewStopScrollListener(wv_day);
        setOnViewStopScrollListener(wv_hours);
        setOnViewStopScrollListener(wv_mins);
        setOnViewStopScrollListener(wv_seconds);
    }
    public void setOnViewStopScrollListener(final WheelView wheelView) {
        wheelView.setOnWheelViewStopScrollListener(new OnViewStopScrollListener() {
            @Override
            public void OnsopListener() {
                setStop(wheelView);
            }
        });
    }
    ...
    public void setOnStopScrollListener(OnScrollStopListener onStopScrollListener) {
        this.onScrollStopListener = onStopScrollListener;
    }

    public void setStop(WheelView wheelView) {
        if (onScrollStopListener!=null){
            onScrollStopListener.WheelView(wheelView);
        }
    }
}
